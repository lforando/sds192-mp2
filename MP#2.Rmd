...
#For our data graphic, we decided to make three plots - one for each of the states we chose to analyze. We put all of the information to design the graphic into a function called state graphic, so that we can call on this function to generate the remaining two graphs without having to re-type all of the code.
